...
class CustomExpression(object):
    ...
    def parse(self):
        ...
        def child_of_domain(left, ids, left_model, parent=None, prefix=''):
            print("gommala idhaanda innovation")
            ...
            if left_model._parent_store:
                domain = OR([
                    [('parent_path', '=like', (rec.parent_path or ' ') + '%')]
...
from odoo.osv import expression as original_expression


def patching():
    original_expression.expression = CustomExpression
